...
export const projects = [
  {
    title: "Vital-Aid",
    description:
      "A charitable healthcare platform enabling real-time consultations, dynamic appointment booking, equipment requests, and AI-powered patient validation. Built using Next.js, Socket.IO, AWS S3, and more.",
    image: "/images/vitalaid.jpg",
    imageWebp: "images/webps/vital-aid-home.webp",
    images: [
      {
        original: "/images/vitalaid.jpg",
        loading: "lazy",
        originalAlt: "Vital Aid Home",
      },
      {
        original: "/images/vitalaid.jpg",
        loading: "lazy",
        originalAlt: "Vital Aid Dashboard",
      },
    ],
    tags: [
      "Next.js",
  ...
  },
  {
    title: "Spotify Clone",
    description:
      "A full-stack music streaming app inspired by Spotify. Features include music playback, playlists, JWT authentication, Cloudinary media handling, and responsive UI.",
    image: "/images/spotify-clone.png",
    imageWebp: "images/webps/spotify-clone.webp",
    images: [
      {
        original: "/images/spotify-clone.png",
        loading: "lazy",
        originalAlt: "Spotify Clone",
      },
      {
        original: "/images/spotify-clone.png",
        loading: "lazy",
        originalAlt: "Spotify Clone Player",
      },
    ],
    tags: [
      "React",
  ...
  },
  {
    ...
    description:
      "A modern full-stack eCommerce platform with product listings, secure Stripe payments, user authentication, and cart management. Built using React, Redux, Context API, and Tailwind CSS.",
    image: "/images/ecommerce.png",
    imageWebp: "images/webps/ecommerce.webp",
    images: [
      {
        original: "/images/ecommerce.png",
        loading: "lazy",
        originalAlt: "eCommerce Home",
      },
      {
        original: "/images/ecommerce.png",
        loading: "lazy",
        originalAlt: "eCommerce Product Page",
      },
    ],
    tags: [
      "React",
...
export const TimeLineData = [
  { year: 2023, text: "Started journey in MERN Stack development" },
  { year: 2024, text: "Built full-stack projects including a Spotify Clone" },
  { year: 2024, text: "Joined Bridgeon Solutions as an Intern" },
  { year: 2025, text: "Launched Vital-Aid: a complete health platform" },
];
